/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./types/worker-configuration.d.ts` (hash: 9669c1d58b264be05206c1cba2e21274)
// Runtime types generated with workerd@1.20250416.0 2025-07-12 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PLAN_STORAGE: DurableObjectNamespace<import("../src/server/routes").PlanStorage>;
		RELEASE_HISTORY: DurableObjectNamespace<import("../src/server/routes").ReleaseHistory>;
		ASSETS: Fetcher;
	}
}
